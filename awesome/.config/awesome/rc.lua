...
local alt_l = "Mod1"
local alt_r = "Mod3"
local terminal = os.getenv("kitty") or "kitty"
...
-- Destroy all notifications
    ...
    -- awful.key({ "Shift", "Control" }, "[", function()
    ...
    -- awful.key({ "Shift", "Control" }, "Down", function()
    -- 	awful.client.focus.byidx(1)
    -- end, { description = "focus next by index", group = "client" }),
    -- awful.key({ "Shift", "Control" }, "Up", function()
    -- 	awful.client.focus.byidx(-1)
    -- end, { description = "focus previous by index", group = "client" }),

    -- By-direction client focus
    awful.key({ "Control", alt_r }, "s", function()
    ...
    awful.key({ "Control", alt_r }, "w", function()
    ...
    awful.key({ "Control", alt_r }, "a", function()
    ...
    awful.key({ "Control", alt_r }, "d", function()
    ...
    -- awful.key({ alt_l, "Control" }, "+", function()
    ...
    awful.key({ modkey, alt_l }, "l", function()
        awful.tag.incmwfact(0.05)
    end, { description = "increase master width factor", group = "layout" }),
    awful.key({ modkey, alt_l }, "h", function()
        awful.tag.incmwfact(-0.05)
...
clientkeys = mytable.join(
    awful.key({ alt_l, "Shift" }, "m", lain.util.magnify_client, { description = "magnify client", group = "client" }),
